    ...
    <div class="container">
        <div class="row">
            @if ($age >= 25 and $age <= 45 and
                ...
                <p>Альфа банк</p>
                <p>9% ставка в год </p>
                <p>ежемесячные выплаты:{{ $payments }}</p>
                <p>сумма переплаты:{{ $pereplata }}</p>
            @elseif ($age >= 20 and $age <= 45 and
                        $data['nationality'] == 'Russian' and
