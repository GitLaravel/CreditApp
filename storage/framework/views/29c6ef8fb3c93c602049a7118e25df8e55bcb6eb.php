  ...
  <body>
    ...
    <!-- Content Header (Page header) -->
        ...
        <section class="content">
            ...
            <?php endif; ?>
            <div class="row">
                <form action="<?php echo e(route('CreditResult.store')); ?>" method="post">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH D:\dist\OpenServer\domains\TestBack\test_back\resources\views/CreditResult/create.blade.php ENDPATH**/ ?>